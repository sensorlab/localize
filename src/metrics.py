...
custom_metrics = {
    'mean_euclidean_distance_error': mean_euclidean_distance_error
}
...
class MetricsHandler():
    ...
    def to_GridsearchCV(self):
        ...
        for name, metric_func in self.metrics.items():
            scorers[name] = sklearn.metrics.make_scorer(self.metrics[name], greater_is_better = self.metrics_names[name])
